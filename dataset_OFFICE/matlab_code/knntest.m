...
% for k=1:2:20
for k=11
    md_36 = fitcknn(xtr_36,ytr_36,'NumNeighbors',k);
    md_nc = fitcknn(xtr_nc,ytr_nc,'NumNeighbors',k);
    md_7 = fitcknn(xtr_7,ytr_7,'NumNeighbors',k);
...
error_7_knn=error7;
error_36_knn=error36;
error_nc_knn=errornc;
save('knn_result.mat','error_7_knn','error_36_knn','error_nc_knn');